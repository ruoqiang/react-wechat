...
export default {
  ...
  mounted() {
    // this._initDate() //为了得到每一项的单独数据执行了一遍
  ...
  methods: {
     _initDate(InitYear, InitMonth, InitDate) {
      ...
      that.picker.on('picker.valuechange', function (selectedVal, selectedIndex) {
       ...
       //   // me.info.CarColorZn = data1[selectedIndex[0]].text
       //   // me.info.carColor = data1[selectedIndex[0]].value
       //   // console.log(me.info.carColor)
