...
import {saveSearch, deleteSearch, clearSearch, savePlay, saveFavorite, deleteFavorite, saveToken} from 'common/js/cache'
...
// export function setToken(song) {
//   return dispatch => {
//     dispatch(actions.setToken(saveToken(song)))
//   }
// }
